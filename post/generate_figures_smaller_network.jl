...
save("figures/smaller_network/others/example_data.png", fig_example_data, px_per_unit=FIGURE_RESOLUTION)
...
save("figures/smaller_network/fig_2_model_forecasts.png", figure_model_forecasts, px_per_unit=FIGURE_RESOLUTION)
...
save("figures/smaller_network/fig_3_model_regularization_strengths.png", figure_regularization_strengths, px_per_unit=FIGURE_RESOLUTION)
...
save("figures/smaller_network/fig_4_sampling_schedules.png", figure_sampling_schedules, px_per_unit=FIGURE_RESOLUTION)
...
for (position, parameters) in enumerate(model_parameters)
  ...
  for p in parameters[2]
    ...
    new_param = ComponentArray(layer_1=layers[1], layer_2=layers[2])
...
save("figures/smaller_network/others/minimal_model_all_fits.png", fig_model_fits, px_per_unit=FIGURE_RESOLUTION)
...
save("figures/smaller_network/fig_5_minimal_model_comparison.png", fig_model_fit_comparison, px_per_unit=FIGURE_RESOLUTION)
...
save("figures/smaller_network/fig_6_minimal_model_auc_comparison.png", fig_boxplot, px_per_unit=FIGURE_RESOLUTION)
...
save("figures/smaller_network/others/fig_s2_model_forecasts_noise.png", figure_model_forecasts, px_per_unit=FIGURE_RESOLUTION)
...
save("figures/smaller_network/others/fig_s3_model_forecasts_initial_conditions.png", figure_model_forecasts, px_per_unit=FIGURE_RESOLUTION)
...
for time_between_samples in times_between_samples
  ...
  save("figures/smaller_network/fig_s4_model_regularization_strengths_$(time_between_samples).png", figure_regularization_strengths, px_per_unit=FIGURE_RESOLUTION)
